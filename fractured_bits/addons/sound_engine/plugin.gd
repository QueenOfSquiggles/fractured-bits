...
func _enter_tree() -> void:
	...
	add_custom_type("SoundLib2D", "Node2D", script,music_note2D)
	add_custom_type("SoundLib3D", "Spatial", script,music_note3D)
	...
	add_custom_type("KeyedAudioStreamPlayer2D", "AudioStreamPlayer2D", keyed2D, music_note)
	add_custom_type("KeyedAudioStreamPlayer3D", "AudioStreamPlayer3D", keyed3D, music_note)
